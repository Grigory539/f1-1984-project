# scripts/load_grid_position.py

import pandas as pd
import psycopg2

print("Загружаем grid_position...")

# Читаем CSV
df = pd.read_csv("data/raw/grid_position.csv")
...
# Очищаем таблицу
cur.execute("TRUNCATE TABLE staging_grid_position RESTART IDENTITY")

# Вставляем данные
for _, row in df.iterrows():
    cur.execute("""
        INSERT INTO staging_grid_position (
